...
<?php
    if($user_id) {
        ...
        try {
            ...
            $db=  mysql_connect('131.179.46.203:3306','andrehsu','Justgoogleit');
            if (!$db) {
        ...
        //    mysql_close($db);
            ...
            $query="INSERT INTO Dating_Participants VALUES (11232, 'Kevin Kuo', 'male','Diamond Bar','Mt Sac','Unemployeed','Stalking','www.facebook.com/kevinkuo')";
